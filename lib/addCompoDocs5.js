#!/usr/bin/env node
// Looks for let {...}: Props = $props() pattern 
// Simply extracts the prop names and default values from the destructuring pattern
...
export const addCompoDocs5 = (srcDir) => {
  ...
  const processFile = (filePath) => {
    ...
    // Find all lines starting with 'let {' and ending with : Props   
